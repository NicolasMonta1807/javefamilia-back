...
public class EspacioEvent
{
    ...
    [JsonProperty("OpeningTime")] public TimeSpan OpeningTime { get; set; }

    [JsonProperty("ClosingTime")] public TimeSpan ClosingTime { get; set; }

    [JsonProperty("Capacity")] public int Capacity { get; set; }

    [JsonProperty("AffiliateRate")] public double AffiliateRate { get; set; }

    [JsonProperty("NonAffiliateRate")] public double NonAffiliateRate { get; set; }
